...
function CartModal({ onClose, onCheckout }) {
  ...
  const handleCheckout = () => {
    ...
    const phone = '01152354323';
    const message = encodeURIComponent(
      `Halo Admin,\nAhmed Said checkout these products please:
      ${cartItems?.map(
          ...
          <div className="border-t border-gray-200 px-5">
            <div className="relative mb-4 mt-4.5">
              ...
              <p className="text-sm mt-1 text-red-700">
                ...
                {' '}
                <Link to="https://github.com/ahmed-said-dev/vshop-spa" className="underline underline-offset-2" target="_blank" rel="noopener noreferrer">
